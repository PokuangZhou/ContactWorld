python eval_planner.py \
  ...
  --ckpt-path logs/ckpts/screwing_nut/pointcloud/vc/tactile_force_field_right/concat/100000.ckpt \
  --isaacgym-cfg-name isaacgym_config_nut \
  --output-dir logs/planning/screwing_nut/100000/step_24/pc_ff \
