python eval_planner.py \
  ...
  --ckpt-path logs/ckpts/screwing_valve/front/vc/tactile_force_field_right/concat/100000.ckpt \
  --isaacgym-cfg-name isaacgym_config_valve \
  --output-dir logs/planning/screwing_valve/100000/step_12/front_ff \
  --vision-key front \
  --vision-type image \
  --image-size 224 \
  --use-tactile \
