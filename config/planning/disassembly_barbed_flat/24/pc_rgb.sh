python eval_planner.py \
  ...
  --ckpt-path logs/ckpts/disassembly_barbed_flat/pointcloud/vc/tactile_rgb_right/concat/100000.ckpt \
  --isaacgym-cfg-name isaacgym_config_barbed_flat \
  --output-dir logs/planning/disassembly_barbed_flat/100000/step_24/pc_rgb \
