python eval_planner.py \
  ...
  --ckpt-path logs/ckpts/disassembly_barbed_flat/wrist/vc/tactile_depth_right/concat/100000.ckpt \
  --isaacgym-cfg-name isaacgym_config_barbed_flat \
  --output-dir logs/planning/disassembly_barbed_flat/100000/step_24/wrist_depth \
  --vision-key wrist \
  --vision-type image \
  --image-size 224 \
  --use-tactile \
