python eval_planner.py \
  ...
  --ckpt-path logs/ckpts/disassembly_barbed_flat/front/vc/tactile_force_field_right/concat/100000.ckpt \
  --isaacgym-cfg-name isaacgym_config_barbed_flat \
  --output-dir logs/planning/disassembly_barbed_flat/100000/step_12/front_ff \
  --vision-key front \
  --vision-type image \
  --image-size 224 \
  --use-tactile \
