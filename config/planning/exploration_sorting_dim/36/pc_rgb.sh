python eval_planner_sorting.py \
  ...
  --ckpt-path logs/ckpts/exploration_sorting_dim/pointcloud/vc/tactile_rgb_right/concat/100000.ckpt \
  --isaacgym-cfg-name isaacgym_config_sorting_dim \
  --output-dir logs/planning/exploration_sorting_dim/100000/step_36/pc_rgb \
