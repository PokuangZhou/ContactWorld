python eval_planner_sorting.py \
  ...
  --ckpt-path logs/ckpts/exploration_sorting_dim/wrist/vc/tactile_depth_right/concat/100000.ckpt \
  --isaacgym-cfg-name isaacgym_config_sorting_dim \
  --output-dir logs/planning/exploration_sorting_dim/100000/step_36/wrist_depth \
  --vision-key wrist \
  --vision-type image \
  --image-size 224 \
  --use-tactile \
