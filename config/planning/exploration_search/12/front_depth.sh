python eval_planner.py \
  ...
  --ckpt-path logs/ckpts/exploration_search/front/vc/tactile_depth_right/concat/100000.ckpt \
  --isaacgym-cfg-name isaacgym_config_search \
  --output-dir logs/planning/exploration_search/100000/step_12/front_depth \
  --vision-key front \
  --vision-type image \
  --image-size 224 \
  --use-tactile \
