python eval_planner.py \
  ...
  --ckpt-path logs/ckpts/exploration_search/pointcloud/vc/tactile_force_field_right/concat/100000.ckpt \
  --isaacgym-cfg-name isaacgym_config_search \
  --output-dir logs/planning/exploration_search/100000/step_48/pc_ff \
