...
'''
ball_table_tennis = gear_small_file  = "ball_class_tabletennis.urdf"
ball_golf         = gear_medium_file = "ball_class_golf.urdf"
nothing           = gear_large_file  = "ball_class_blank.urdf"
ball_base         = base_file        = "ball_class_base.urdf"
'''
...
class TacSLEnvSorting(TacSLBaseGear, TacSLSensors, FactoryABCEnv):
    ...
    def _import_env_assets(self):
        ...
        gear_small_file  = "ball_class_tabletennis.urdf"
        gear_medium_file = "ball_class_golf.urdf"
        gear_large_file  = "ball_class_blank.urdf"
        # base_file = "ball_class_base.urdf"
        base_file = "solo_sort_ball.urdf"        
